...
def parse_data_from_subcategory(html, brands, city):
    ...
    upper_div = soup.find('main', class_='css-i3pbo').find('div', class_='css-j6iz2w css-3nngaf-Layout')
    ...
    for product in products:
        ...
        pre_product_price = format_price(product.find('div', class_='active css-xtv3eo').text[:-2])
